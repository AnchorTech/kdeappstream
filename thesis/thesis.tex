...
\lstset{
   language=C++,
   emph={QPainter,QRegion,RenderFlags,QPaintEngineState,QPaintEngine,Qt,QTextItem,QRect,QRectF,QPoint,QPointF,QLine,QLineF,QEllipse,QPainterPath,QPixmap,QImage},
